...
function createOrg1() {
  ...
  set -x
  fabric-ca-client enroll -u http://peer0:peer0pw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.xxzx.com/peers/peer0.org1.xxzx.com/msp --csr.hosts peer0.org1.xxzx.com 
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u http://peer0:peer0pw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.xxzx.com/peers/peer0.org1.xxzx.com/tls --enrollment.profile tls --csr.hosts peer0.org1.xxzx.com --csr.hosts localhost 
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u http://user1:user1pw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.xxzx.com/users/User1@org1.xxzx.com/msp 
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u http://org1admin:org1adminpw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.xxzx.com/users/Admin@org1.xxzx.com/msp 
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client register --caname ca-orderer --id.name orderer1 --id.secret orderer1pw --id.type orderer 
  { set +x; } 2>/dev/null

    set -x
  fabric-ca-client register --caname ca-orderer --id.name orderer2 --id.secret orderer2pw --id.type orderer 
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u http://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/xxzx.com/orderers/orderer.xxzx.com/msp --csr.hosts orderer.xxzx.com --csr.hosts localhost 
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u http://orderer1:orderer1pw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/xxzx.com/orderers/orderer1.xxzx.com/msp --csr.hosts orderer1.xxzx.com --csr.hosts localhost 
  { set +x; } 2>/dev/null
  ...
  cp ${PWD}/organizations/ordererOrganizations/xxzx.com/msp/config.yaml ${PWD}/organizations/ordererOrganizations/xxzx.com/orderers/orderer1.xxzx.com/msp/config.yaml
   ...
   set -x
  fabric-ca-client enroll -u http://orderer2:orderer2pw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/xxzx.com/orderers/orderer2.xxzx.com/msp --csr.hosts orderer2.xxzx.com --csr.hosts localhost 
  { set +x; } 2>/dev/null
 ...
 infoln "Generating the orderer-tls certificates"
  set -x
  fabric-ca-client enroll -u http://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/xxzx.com/orderers/orderer.xxzx.com/tls --enrollment.profile tls --csr.hosts orderer.xxzx.com --csr.hosts localhost 
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u http://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/xxzx.com/users/Admin@xxzx.com/msp 
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u http://orderer1:orderer1pw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/xxzx.com/orderers/orderer1.xxzx.com/tls --enrollment.profile tls --csr.hosts orderer1.xxzx.com --csr.hosts localhost 
  { set +x; } 2>/dev/null
 ...
 set -x
  fabric-ca-client enroll -u http://orderer2:orderer2pw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/xxzx.com/orderers/orderer2.xxzx.com/tls --enrollment.profile tls --csr.hosts orderer2.xxzx.com --csr.hosts localhost 
  { set +x; } 2>/dev/null
